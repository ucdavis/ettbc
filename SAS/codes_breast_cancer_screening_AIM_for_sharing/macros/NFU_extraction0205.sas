/********************************************************************/
/* This macro extracts the Nursing Facility Utilization in 2002-05 */
...
%macro nfu0205(test= ,hcpcs=, margin=, one=1, datehcpcs= ,id= , year= ,fileopc= , fileopr= , filecarl= , fromdt= , thrudt= , hcpcsfield= ,posfield=, claimid= ,pos=);
...
data test_opr_pre;
set &fileopr (keep= &id &hcpcsfield &datehcpcs &claimid /*obs=500000*/);
&test=0;
...
data test_car_pre;
set &filecarl (keep= &id &hcpcsfield /*&datehcpcs &thrudt*/ &claimid sexpndt1 sexpndt2 &posfield  /*obs=5000000*/ ) ;

/********************************************************************/
/* This macro extracts the Nursing Facility Utilization in 2001 */
...
*/
/* */
%macro nfu01(test= ,hcpcs=, margin=, one=1, datehcpcs= ,id= , year= ,fileopc= , fileopr= , filecarl= , cpt_right_end= , fromdt= , thrudt= ,hcpcsfield= ,posfield=, claimid= , claimid_car= ,pos= );

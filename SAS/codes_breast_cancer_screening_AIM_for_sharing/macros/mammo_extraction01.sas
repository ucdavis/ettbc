/********************************************************************/
/* This macro extracts all the mammographies done in 2001 */
...
/* */
%macro scrmammo01(test= ,hcpcs=, margin=, one=1, datehcpcs= ,id= , year= ,fileopc= , fileopr= , filecarl= , cpt_right_end= , fromdt= , thrudt= ,hcpcsfield= ,claimid= , claimid_car= );

/********************************************************************/
/* This macro extracts all the mammograms done in years 1999 and 2000 */
...
%macro scrmammo00(test= ,hcpcs=, margin=, one=1, datehcpcs= ,id= , year= ,fileopc= , fileopr= , filecarl= , cpt_right_end= , fromdt= , thrudt= ,hcpcsfield= ,claimid= , claimid_car= );

/*********************************************************************/
/** Extraction of Nursing Facility Utilization. This is the first step for LTC identification    **/
/** Following the algorithm in Health Serv Outcomes Res Method 10:100 			    **/
/** Extracts the first date of Nursing Facility Utilizaton  **/
/*********************************************************************/



%include '/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/macros/NFU_extraction0612.sas';
%include '/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/macros/NFU_extraction0205.sas';
%include '/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/macros/NFU_extraction01.sas';
%include '/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/macros/NFU_extraction99.sas';
%include '/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/macros/NFU_extraction00.sas';
...
/*proc freq data=car1999.carh1999;
table bplacsv;
run;
endsas;*/
...
/* YEAR 1999 */
%nfu99(test=nfu , 
hcpcs=('99301','99302','99303','99311','99312','99313','99315','99316','99379','99380','G0066'),
pos=('31','32','33'),
margin=0,
datehcpcs=srev_dt,
id= ehic,

...
%macro cann16_7074(/*agein1= ,agein2=, agein3=, agein4=,*/ agegroup= );
proc printto print="/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/programs/CODES_FOR_ANNALS_REVIEW/cann16_logsANDlsts/cann16_12mbaseadjps2LEV&agegroup..lst" new; run;
proc printto log="/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/programs/CODES_FOR_ANNALS_REVIEW/cann16_logsANDlsts/cann16_12mbaseadjps2LEV&agegroup..log" new;run;
...
/*comcom_base*/ baseline_combinedscore
...
proc freq data=basecovs&agegroup; 
table region baseline_combinedscore ervisit6m_base2 daysin6m_base2 / missing; run;
...
/* weight datasets are already sorted by bene_id age month */
...
/***********************************/
/* macro for the Baseline-adjusted curves */
/***********************************/
...
CHF_base CKD_base COPD_base CRC_base depre_base diabetes_base endometrial_base glaucoma_base hip12_base HTA_base hypoth_base IHD_base lipid_base lung_base osteo_base RA_base stroke12_base age );
/*if arm ne 'COLO';*/
	...
	/*division2=(division=2);division3=(division=3);division4=(division=4);division5=(division=5);division6=(division=6);division7=(division=7);division8=(division=8);division9=(division=9 OR division=0);*/

	region1=(region=1);region2=(region=2);region4=(region=4);
	
	/*er1=(ervisit6m_base=1); er2=(ervisit6m_base=2);*/

	in1=(daysin6m_base2=1);in2=(daysin6m_base2=2);/*in3=(daysin6m_base=3);*/

	comcom_c0=(baseline_combinedscore='0'); /*comcom_c1=(comcom_base='1'); comcom_c2=(comcom_base='2'); comcom_c3=(comcom_base='3');*/
...
proc logistic data=event_all descending outest=mle_est noprint;
	...
	title "Baseline-adjusted analysis";
	where 0<=month3<=95;
run;
...
data surv_new (keep = month3 s_x1 s_x2 s_x3) ;
...
PROC EXPORT DATA= WORK.TOTALR 
		OUTFILE= "/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/data/annals_review/ps_ann_baseadj12m_&event&agegroup..csv"
            DBMS=CSV REPLACE;
     PUTNAMES=YES;
RUN; 
...
%macro cann16_7584(/*agein1= ,agein2=, agein3=, agein4=,*/ agegroup= );
proc printto print="/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/programs/CODES_FOR_ANNALS_REVIEW/cann16_logsANDlsts/cann16_12mbaseadjps2LEV&agegroup..lst" new; run;
proc printto log="/disk/agedisk3/medicare.work/newhouse-DUA25730/xabi/BC_screening/programs/CODES_FOR_ANNALS_REVIEW/cann16_logsANDlsts/cann16_12mbaseadjps2LEV&agegroup..log" new;run;
...
/*proc contents data=longcovs&agegroup; run;
%return;*/
...
/* from the unexpanded dataset, I select baseline variables */
data basecovs&agegroup;
set /*mydata.*/longcovs&agegroup (keep= 
bene_id age month year_base race_c region 
ervisit6m_base2 daysin6m_base2 
/*comcom_base*/ baseline_combinedscore
cvd_prev_base crc_prev_base diabetes_prev_base pelvic_prev_base influenza_base bonemass_base previsit_base 
...
data backbone&agegroup; set /*mydata.*/long12m&agegroup (drop=bc_long monthBC);run; 
